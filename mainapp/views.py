...
def new_travel(request):
    ...
    return render(request, 'add.html', {"form":form, "today":today, "my_pp":my_pp})
...
def search(request):
    ...
    return render(request, 'find_flights.html', context)
...
def track_follow(request,pk,opp):
    ...
    return render(request,'toggle_follow.html', {"usern":user,"title":title, "is_following":is_following, "my_pp":my_pp,"profile":profile})
...
def notifiy(request):
    ...
    return render(request, 'notification.html', {'notifications':notification,'my_pp':my_pp})
